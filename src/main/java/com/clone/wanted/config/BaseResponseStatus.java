...
public enum BaseResponseStatus {
	...
	USER_SIGN_SUCCESS(true, 5002, "회원가입에 성공했습니다"),
	USER_SIGN_ERROR(false, 5003, "회원가입에 실패했습니다"),
	EMAIL_FOUND(true, 5004, "이메일 확인에 성공했습니다"),
	EMAIL_NOT_FOUND(false, 5005, "이메일 확인에 실패했습니다"),
